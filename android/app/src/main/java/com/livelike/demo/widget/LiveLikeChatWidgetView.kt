...
class LiveLikeChatWidgetView(
    ...
    private fun registerPinMessagesHandler() {
        pinMessageAdapter.pinMessageHandler = object : PinMessageAdapter.PinMessageActionHandler {
            ...
            override fun onDismissPinMessage(message: String?) {
                val params = Arguments.createMap()
                params.putString("message", message)
                sendEvent(EVENT_DISMISS_PINNED_MESSAGE, params)
            }
        }
    }
    ...
    companion object {
        ...
        const val EVENT_DISMISS_PINNED_MESSAGE = "onPinnedMessageDismissed"
    }
}