...
class SeparatedVideoViewController: UIViewController {
  ...
  private lazy var tabBarViewController: TabBarTableViewController = {
    let vc = TabBarTableViewController(contentSession: self.contentSession)
  ...
  init(sdk: EngagementSDK) {
    contentSession = sdk.contentSession(config: SessionConfiguration(programID: "2a69e084-721a-4ba4-b692-e42846ab3a7a"))
...
extension SeparatedVideoViewController {
  private func setUpEngagementSDKLayout() {
    ...
    self.widgetViewController.session = contentSession
